...
function bulkCreateProgrammingExercises(courseId, exercises) {
    return new Promise(function (resolve, reject) {
        axios_1["default"]
...
exports.bulkCreateProgrammingExercises = bulkCreateProgrammingExercises;
